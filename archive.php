  ...
  <main id="main" class="site-main">
    ...
    <?php if(is_paged()) : ?>
      ...
      <div class="button-container text-center container-load-prev">
        <button type="button" class="btn btn-outline-light codesavages-load-button" data-prev="1" data-archive="<?php echo $_SERVER["REQUEST_URI"]; ?>" data-page="<?php echo codesavages_check_paged(1); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
