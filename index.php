...
<div id="primary" class="content-area">
  <main id="main" class="site-main">
    ...
    <div class="button-container text-center">
      <button type="button" class="btn btn-outline-dark codesavages-load-button" data-page="<?php echo codesavages_check_paged(1); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
